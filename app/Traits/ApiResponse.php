...
trait ApiResponse
{
    ...
    {
        return response()->json(self::baseResponse(code: (string) $code, success: true, message: $message, data: $data), $code);
    }
    ...
    {
        return response()->json(self::baseResponse(code: (string) $code, success: false, message: $message, data: $data), $code);
    }
     ...
     */
    protected static function unauthorized(?string $message = null, int $code = 401, mixed $data = []): JsonResponse
    {
        return response()->json(self::baseResponse(code: (string) $code, success: false, message: $message, data: $data), $code);
    }
}
