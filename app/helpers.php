...
if (! function_exists('get_country_codes')) {
    /**
     * Get a map of ISO codes to dial codes.
     *
    ...
    function get_country_codes(): array
    {
        return [
            ...
            'ES' => '+34', 'LK' => '+94', 'SD' => '+249', 'SR' => '+597', 'SZ' => '+268', 'SE' => '+46',
            'CH' => '+41', 'SY' => '+963', 'TW' => '+886', 'TJ' => '+992', 'TZ' => '+255', 'TH' => '+66',
            'TG' => '+228', 'TO' => '+676', 'TT' => '+1', 'TN' => '+216', 'TR' => '+90', 'TM' => '+993',
...
if (! function_exists('get_country_options')) {
    /**
     * Get a simple key-value list for select options with HTML flags and dial codes.
     *
     * @return array<string, string>
     */
    function get_country_options(): array
    {
        $dialCodes = get_country_codes();
        $options = [];

        foreach ($dialCodes as $iso => $dialCode) {
            $lowerIso = strtolower($iso);
            $options[$iso] = "<span class=\"fi fi-{$lowerIso}\"></span> {$dialCode}";
        }
...
if (! function_exists('get_dial_code')) {
    ...
    {
        return get_country_codes()[$iso] ?? '+855';
    }
}
