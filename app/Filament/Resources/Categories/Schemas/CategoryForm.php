    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                Grid::make(3)
                    ->schema([
                        Section::make(__('admin.resources.category.basic_info'))
                            ->columnSpan(2)
                            ->columns(2)
                            ->schema([
                                ...
                                Textarea::make('description_en')
                                    ->label(__('admin.resources.category.description_en'))
                                    ->columnSpanFull(),
                                Textarea::make('description_km')
                                    ->label(__('admin.resources.category.description_km'))
                                    ->columnSpanFull(),
                            ]),

                        Section::make(__('admin.resources.category.visuals'))
                            ->columnSpan(1)
                            ->schema([
