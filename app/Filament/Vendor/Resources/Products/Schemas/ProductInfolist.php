        ...
        return $schema
            ->components([
                Section::make(__('shared.product.general_info'))
                    ->columns(2)
                    ->schema([
                        TextEntry::make('product.productCategory.name_en')->placeholder(__('admin.resources.general.not_provided'))
                            ->label(new HtmlString('<strong>'.__('shared.product.system_category').'</strong>')),
                        TextEntry::make('product.description_en')->placeholder(__('admin.resources.general.not_provided'))
                            ->label(new HtmlString('<strong>'.__('shared.product.description_en').'</strong>'))
                            ->columnSpanFull()
                            ->placeholder('-'),
                        TextEntry::make('product.description_km')->placeholder(__('admin.resources.general.not_provided'))
